...
class Dashboard extends Component {
  ...
  getProduct = () => {
    ...
    axios.get(`${SERVER_URL}/get-product${data}`, {
      headers: {
  ...
  deleteProduct = (id) => {
    axios.post(`${SERVER_URL}/delete-product`, {
      id: id
    }, {
      headers: {
  ...
  addProduct = () => {
    ...
    file.discount = this.state.discount
    file.price = this.state.price

    axios.post(`${SERVER_URL}/add-product`, file, {
      headers: {
        'token': this.state.token
      }
    }).then((res) => {
  ...
  updateProduct = () => {
    ...
    axios.post(`${SERVER_URL}/update-product`, file, {
      headers: {
        'token': this.state.token
      }
    }).then((res) => {
